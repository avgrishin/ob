...
//{
//  public class EnregOldController : BaseController
//  {
...
//    public EnregOldController(IEnregRepository _enregRepository, IConfigurationProvider configProvider)
//    {
//      enregRepository = _enregRepository;
//      _configProvider = configProvider;
//    }

//    public EnregOldController(IEnregRepository _enregRepository, IConfigurationProvider configProvider, int _enregTypeID)
//    {
//      enregRepository = _enregRepository;
//      _configProvider = configProvider;
...
//    [Authorize(Roles = "jrpk, jrpki, jrpkr")]
//    public virtual ActionResult getEnregList(DateTime? d1, DateTime? d2, Boolean? sd, string sort, string dir)
//    {
...
//    public virtual async Task<ActionResult> addEnreg(List<Enregistrement> data)
//    {
//      //try
//      {
//        return new JsonnResult { Data = new { success = true, data = await enregRepository.AddEnreg(data, EnregTypeID, User.Identity.Name) } };
//      }
//      //catch (Exception ex)
//      //{
...
//    public virtual async Task<ActionResult> updEnreg(List<Enregistrement> data)
//    {
//      return new JsonnResult { Data = new { success = true, data = await enregRepository.UpdEnreg(data, User.Identity.Name, User.IsInRole("jrpkm"), User.IsInRole("Admin"), EnregTypeID) } };
//    }

//    [Authorize(Roles = "admin")]
//    public virtual ActionResult delEnreg(List<tEnregistrement> data)
//    {
...
//    {
//      var b = enregRepository.AddPayment(id);
